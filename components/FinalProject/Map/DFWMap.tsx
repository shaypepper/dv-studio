...
const Map: React.FC = ({ className, landmark }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" className={className}>
      ...
      <text transform="translate(0 2)" fontSize="1" fontFamily="nytfranklin" fontWeight="700">
        MAP OF DALLAS-FORT WORTH
      </text>
      <g id="Map" data-name="Layer 1" mask="url('#gradient-mask')">
        <path
          className="cls-2"
          d="M26,25.6a2.88,2.88,0,0,0,.59.45,2.29,2.29,0,0,0,.69.26,2.84,2.84,0,0,1,.86.3,8.78,8.78,0,0,1,.76.48l.55.36.55.34.77.42c.26.13.52.27.77.42.4.25.81.5,1.23.72A13.75,13.75,0,0,0,34,30a5.08,5.08,0,0,0,.59.17l.61.11"
        />
        <path
          className="cls-2"
          d="M35.07,14.69c-.2.1-.91.51-1.09.64a4.91,4.91,0,0,0-.51.39,3.46,3.46,0,0,1-.67.43l-.72.35-1.4.64a8.33,8.33,0,0,0-1.32.78l-.16.13a.62.62,0,0,1-.19.07"
        />
        <path
          className="cls-2"
          d="M35.63,26.49a5.24,5.24,0,0,1-.56,0H34.5a2.32,2.32,0,0,1-.38-.05l-.38-.08-.22,0a.76.76,0,0,0-.21,0l-.43,0-.43,0-.4,0h-.4c-.21,0-.41,0-.62,0l-.61.07-.32,0h-.33a1,1,0,0,0-.24,0h-.24"
        />
        <path
          className="cls-2"
          d="M36.32,21.5c-.6-.16-1.21-.29-1.82-.41l-1.82-.36-1.06-.22-1.07-.2c-.21,0-.42,0-.64-.06h-.64"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M34.6,5l-.51.41L32.21,6.83,30.34,8.26a1.06,1.06,0,0,0-.26.3l-.21.34a1.4,1.4,0,0,0-.15.3,2.85,2.85,0,0,1-.12.31"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M4.34,28H3.15l-.89,0-.89,0A1.52,1.52,0,0,0,1,28c-.14,0-.27.07-.42.09-.31.05-.62.08-.94.1"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M11.73,26.15a1,1,0,0,0-.37,0c-.13,0-.25,0-.38,0h-.19a.27.27,0,0,1-.18-.07.23.23,0,0,0-.18,0l-.19,0-.73.07a4.46,4.46,0,0,1-.73,0H8.67a.16.16,0,0,1-.09-.06.51.51,0,0,0-.29-.17,1.83,1.83,0,0,0-.33,0H7.32l-.63,0-.55,0-.55-.06a8.5,8.5,0,0,0-.87-.07l-.86,0a1.79,1.79,0,0,0-.46.09L3,25.92l-.12,0H1.69l-1,0H.21a3.25,3.25,0,0,1-.44,0"
        />
        <path className="cls-2" d="M18-.6a3.53,3.53,0,0,1,0,.46v.06S18,0,18,0" />
        <path
          className="cls-2"
          d="M12.76,22.05a6.11,6.11,0,0,0-.86.06c-.29,0-.57.1-.86.16a2.3,2.3,0,0,1-.45.05h-.47l-.22,0-.23.05a2.16,2.16,0,0,1-.44.1,3.4,3.4,0,0,1-.45,0c-.87,0-1.73,0-2.59,0h-7.4"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M21.49,35.18s0,0,0,0,0,0,0,0a.75.75,0,0,1,.07-.12l.07-.11a.91.91,0,0,0,.12-.31.79.79,0,0,0,0-.34,2,2,0,0,1,0-.43l0-.45a.93.93,0,0,0,0-.24.57.57,0,0,0-.11-.22,3.93,3.93,0,0,1-.45-.83c-.13-.29-.24-.58-.36-.87s-.18-.38-.26-.58a4,4,0,0,1-.18-.62l.76-.24a6.77,6.77,0,0,1,.77-.22l.54-.12a3.16,3.16,0,0,0,.53-.13.8.8,0,0,0,.25-.11.91.91,0,0,0,.23-.17,1.48,1.48,0,0,0,.38.33c.14.09.29.17.42.27a1.66,1.66,0,0,1,.19.18.88.88,0,0,1,.14.23c.2.46.39.92.57,1.39s.37.93.57,1.38.31.75.46,1.12.31.75.47,1.12l0,.08a.08.08,0,0,0,.08,0"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M29.64,9.61a.83.83,0,0,0-.14.3,1.67,1.67,0,0,1-.08.32l-.16.55c-.05.19-.1.38-.14.56l0,.15v.15a.61.61,0,0,1,0,.33.83.83,0,0,1-.16.29.07.07,0,0,1-.06,0H28a.89.89,0,0,0-.08.32c0,.11,0,.22,0,.33a1.5,1.5,0,0,1-.05.37,1.66,1.66,0,0,1-.16.33l-.45.73-.45.73"
        />
        <path
          className="cls-2"
          d="M29,18.26a.61.61,0,0,1,.08.26c0,.09,0,.18,0,.27l.12,1c0,.33.07.65.09,1s0,.4,0,.61a2.11,2.11,0,0,0,.11.6c0,.15.1.3.15.45s.12.3.17.45.09.25.14.38a1.37,1.37,0,0,1,.09.4,2.93,2.93,0,0,1,0,.66c0,.22-.08.43-.13.65a2.94,2.94,0,0,1-.22.61c-.09.2-.18.4-.25.6a4.16,4.16,0,0,1-.24.47,3.25,3.25,0,0,0-.25.45"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M20.38,30.07l-.51.16c-.16.05-.33.11-.5.15l-.1,0H17.64a6.17,6.17,0,0,1-1.42-.21,4,4,0,0,1-1.31-.62l-.75.84-.73.84c-.21.24-.43.48-.65.71s-.45.45-.66.69l-.74.85c-.25.29-.5.58-.73.87l-.37.42-.39.4h0"
        />
        <path
          className="cls-2"
        ...
        <path
          className="cls-2"
          d="M28.84,27.15a.54.54,0,0,1-.29.23c-.12,0-.25.06-.36.09l-.84.22-.84.21a3.1,3.1,0,0,1-.42.08l-.42,0a1.59,1.59,0,0,0-.39.08,1.73,1.73,0,0,0-.37.16l-.62.36-.63.36L23.6,29l-.06,0"
        />
        <path
          className="cls-2"
      ...
      <g id="Locations">
        ...
        <circle
          ...
          fill={landmark === ChurchKeys.FBC ? fillColor : 'grey'}
          r="0.5"
          data-church="fbc"
        />
        <circle
          transform="translate(20.5 11.5)"
          fill={landmark === ChurchKeys.Watermark ? fillColor : 'grey'}
          r="0.5"
          data-church="watermark"
        />
        <circle
          transform="translate(16 14.5)"
          fill={landmark === ChurchKeys.TVC ? fillColor : 'grey'}
          r="0.5"
          data-church="tvc"
        />
        <circle transform="translate(19 21)" fill={colors.primary} r="1" data-church="scene" />
        <circle
          transform="translate(16 4.5)"
          fill={landmark === ChurchKeys.Prestonwood ? fillColor : 'grey'}
          r="0.5"
          data-church="prestonwood"
        />
        <circle
          transform="translate(16.75 7)"
          fill={landmark === ChurchKeys.Covenant ? fillColor : 'grey'}
          r="0.5"
          data-church="covenant"
        />
        <circle
          transform="translate(6.75 9)"
          fill={landmark === ChurchKeys.Fellowship ? fillColor : 'grey'}
          r="0.5"
